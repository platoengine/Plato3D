...
class AnalyzeStabilizedThermomechanics extends AnalyzeScenarioBase {
  constructor () {
    super()
    this.hostPhysics = 'Stabilized Thermomechanics'
    this.modelviews = {
      'Problem': {
        'data': {},
        'view': {
          'type': 'single-view',
          '<Template>': {
            'Physics': { type: 'string', value: 'Stabilized Thermomechanical', fixed: true },
...
export default AnalyzeStabilizedThermomechanics
