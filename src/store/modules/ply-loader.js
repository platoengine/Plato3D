  ...
  parse: function (data) {
      ...
      for (var i = 0; i < lines.length; i++) {
        ...
        switch (lineType) {
          ...
          case 'element':
            ...
            break
          case 'property':
            currentElement.properties.push(makePlyElementProperty(lineValues, scope.propertyNameMapping))
            break
        }
      }
      if (currentElement !== undefined) {
    ...
    function handleElement (buffer, elementName, element) {
      if (elementName === 'vertex') {
        ...
        var vertexIndices = element.vertex_indices || element.vertex_index // issue #9338
...
exports.PLYLoader = THREE.PLYLoader
